...
export default function Home() {
    ...
    return ( <
        ...
        /div> <
        /div>   <
        div className = "pl-10 pr-10 pt-10 text-[#6A7CC8] text-[50px] font-extraboldfont-['Montserrat'] " >
        <
        p > Pilih games yang < /p> <
        p > kamu inginkan < /p> <
        /div> <
        div className = "pl-10 text-white text-[px] font-['MADE Sunflower'] font-[900]" >
        <
