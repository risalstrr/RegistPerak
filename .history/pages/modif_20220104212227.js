...
export default function Home() {
  return (
    <div className="bg-[#EBC761] h-[70rem] w-full">
        <div class="absolute lg:bottom-32 lg:left-[772px] -bottom-44 -left-60  ">
            <Image
            src="/kuning.svg"
            width={400}
            height={380}
      ...
      <div className=' flex flex-wrap lg:flex-row p-7'>
            <div href="#" className="sm:hidden block px-4 py-3 lg:py-4 ">
                <Image
                    src="/Brawlhalla.svg"
                    width={260}
                    height={220}
