...
export default function Home() {
    ...
    return ( <
        ...
        label className = "block pl-10 pt-3" >
        <
        span class = "after:ml-0.5 after:text-red-500 block w-20 text-sm font-medium text-gray-700" >
        Pilih Gambar <
        /span> <
        input type = "email"
        name = "email"
        class = "mt-1 px-3 py-2 bg-white border shadow-sm w-full border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" / >
        <
        /label> <
        /div> <
        div className = 'block pl-10 pt-3' >
