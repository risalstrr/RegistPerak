export default function Home() {
    return ( <
        ...
        <
        div className = "bg-[#E5B632] border-2 border-black relative md:w-9/12 md:h-7/12 lg:w-5/12 lg:h-72 bg-white rounded" >
        <
        div >
        <
        ...
        /p> <
        /div> <
        div className = 'flex justify-center px-4 py-3 lg:py-0' >
        <
