...
export default function Home() {
    ...
    return ( <
        ...
        <
        /div> <
        div class = "md:hidden absolute lg:bottom-[180px] z-0 lg:left-[970px] -bottom-44 -left-60  " >
        <
        ...
        input type = "text"
        name = "pilih gambar"
        className = "mt-1 px-3 py-2 bg-white border-2 shadow-sm w-9/12 border-black placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" / >
        <
        /label> <
        /div>
        ...
        input type = "text"
        name = "NPM"
        className = "mt-1 px-3 py-2 bg-white border-2 shadow-sm w-4/12 border-black placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1"
