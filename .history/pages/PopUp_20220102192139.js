export default function Home() {
    return ( <
        ...
        <
        button className = "rounded-md border-2 items-center border-black ml-20 mt-2 w-6/12 h-10 transition ease-in-out delay-150 bg-[#EE200C] hover:-translate-y-1 hover:scale-110 hover:bg-[#FAA299] text-white duration-300 ... " >
        Batal <
        /button> <
        /div> <
