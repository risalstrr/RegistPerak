...
export default function Home() {
  return (
    <div className="bg-[#EBC761] relative w-full h-full">
        {/* <div class="absolute -top-36 -right-2">
            <Image
            src="/biru.svg"
            width={340}
            height={540}
        ...
        <div class="absolute lg:top-60 lg:right-96 -bottom-44 -left-60 xl:hidden ">
            <Image
            src="/kuning.svg"
            width={380}
            height={366}
        ...
        <div class="absolute lg:top-60 lg:right-96 sm:hidden">
            <Image
            src="/kuning.svg"
            width={380}
            height={366}
      ...
      <div className=' flex flex-wrap lg:flex-row p-7'>
        ...
        {/* <div class="absolute -bottom-20 -right-3">
            <Image
            src="/merah.svg"
            width={400}
            height={360}
