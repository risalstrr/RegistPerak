...
export default function Home() {
    ...
    return ( <
        ...
        div className = 'block pl-10 pt-3' >
        <
        button className = "rounded-lg text-[10px] z-10 w-28 h-10 transition ease-in-out delay-150 bg-[#CC9D1A] border-4 border-[#F1D78E] hover:-translate-y-1 hover:scale-110 hover:bg-[#F1D78E] duration-300 ... " >
        Upload File <
        /button> <
        /div> <
