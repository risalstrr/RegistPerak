export default function Home() {
    return ( <
        ...
        <
        div className = "rounded-md border-2 border-black justify-center items-center w-4/12 h-14 transition bg-[#FAA299]" >
        <
        div className = "rounded-md border-2 border-black w-32 transition bg-[#FAA299]" > {
