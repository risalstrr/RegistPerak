...
export default function Home() {
  ...
  return (
    <div className="relative bg-[#EBC761] w-full h-full font-['Montserrat']">
      <div className=' flex flex-col lg:flex-row bg-[#F1D78E]'>
      <Head>
        <title>Homepage Pendaftaran</title>
      </Head>
      <div class="absolute md:hidden lg:bottom-14 z-0 lg:left-[772px] -bottom-44 -left-60  ">
            <Image
            src="/kuning.svg"
            width={380}
            height={366}
      ...
      {/* <div class="absolute md:hidden lg:bottom-[145px] z-0 lg:left-[905px] -bottom-44 -left-60  ">
            <Image
            src="/canvas.svg"
            width={480}
            height={470}
      ...
      <div class="absolute md:hidden lg:bottom-[180px] z-0 lg:left-[970px] -bottom-44 -left-60  ">
            <Image
      ...
      <button className="rounded-lg z-10 lg:w-4/12 lg:h-10 border-4 border-[#03F182] md:w-4/12 md:h-12 w-5/12 h-12 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ...">
          Daftar Sekarang
      </button>
      </div>
    ...
    <div className='absolute -bottom-32 right-0'> 
      ...
      <div className='absolute z-8 -bottom-32 -left-6'> 
        <Image
          src="/leftcloud.svg"
          width = {880}
          height = {300}
