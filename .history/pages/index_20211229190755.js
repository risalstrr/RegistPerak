...
export default function Home() {
    ...
    return ( <
        ...
        /Head> <
        div className = 'z-10 flex flex-col lg:flex-row bg-[#F1D78E]' >
        <
        ...
        div className = 'bg-[#EBC761] hidden lg:block lg:absolute -bottom-14 right-0' >
        <
        ...
        <
        /div> <
        div className = 'bg-[#EBC761] hidden lg:block lg:absolute -bottom-14 -left-6' >
        <
