...
export default function Home() {
    ...
    return ( <
        ...
        <
        button className = "rounded-lg z-30 lg:w-4/12 lg:h-10 border-4 border-[#03F182] md:w-4/12 md:h-12 w-5/12 h-12 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ..." >
        Daftar Sekarang <
        /button> <
        /div>
