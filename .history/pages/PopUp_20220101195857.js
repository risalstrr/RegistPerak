export default function Home() {
    return ( <
        ...
        Batal <
        /button> <
        button className = "rounded-md border-4 w-28 h-10 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ... " >
        Simpan <
        /button> <
        /div> <
        /div> <
