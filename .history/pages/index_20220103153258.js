  ...
  return (
    <div className="relative bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <div class="absolute md:hidden lg:bottom-14 z-0 lg:left-[772px] -bottom-44 -left-60  ">
        ...
        <div class="absolute z-0 top-24 -right-56 lg:-top-36 lg:-right-0">
            <Image
            src="/biru.svg"
            width={340}
            height={540}
    ...
    <div className='absolute -bottom-60 right-0'> 
      ...
      <div className='absolute pl-10 pt-10 pb-20'>
      <button className="rounded-lg z-20 lg:w-4/12 lg:h-10 border-4 border-[#03F182] md:w-4/12 md:h-12 w-5/12 h-12 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ...">
          Daftar Sekarang
      </button>
      </div>
    </div>
