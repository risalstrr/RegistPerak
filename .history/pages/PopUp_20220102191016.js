export default function Home() {
    return ( <
        ...
        /p> <
        /div> <
        div className = 'flex flex-wrap gap-6 justify-center items-center lg:py-0' >
        <
        div className = "rounded-md border-2 border-black w-54 h-14 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 bg-[#FAA299]" >
        <
        button className = "rounded-md border-2 border-black w-56 h-10 transition ease-in-out delay-150 bg-[#EE200C] hover:-translate-y-1 hover:scale-110 hover:bg-[#FAA299] text-white duration-300 ... " >
        Batal <
        /button> <
        /div> <
        div className = "rounded-md border-2 border-black w-54 h-14 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 bg-[#03F182]" >
        <
