...
export default function Home() {
    return ( <
        ...
        <
        div className = 'w-56 h-56 border-2 border-black rounded-lg shadow-2xl bg-[#8648BA]' >
        <
        button className = ' w-52 h-52 m-2 border-[#8648BA] rounded-lg shadow-2xl bg-[#2E1145]' >
        <
        /button> <
        /div> <
        /div> <
