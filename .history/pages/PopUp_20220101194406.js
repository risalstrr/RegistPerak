export default function Home() {
    return ( <
        div className = "bg-white border-2 border-black w-full h-screen flex flex-col justify-center items-center md:px-1 mb-24 font-['Montserrat'] p-2" >
        <
        div className = "bg-[#E5B632] relative md:w-9/12 md:h-80 lg:w-5/12 lg:h-72 bg-white rounded-lg" >
        <
        div >
        <
