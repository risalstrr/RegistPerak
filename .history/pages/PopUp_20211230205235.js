export default function Home() {
    return ( <
        ...
        div className = 'flex' >
        <
        button className = "pr-10 rounded-lg w-28 h-10 transition ease-in-out delay-150 bg-[#CC9D1A] hover:-translate-y-1 hover:scale-110 hover:bg-[#F1D78E] duration-300 ... " >
        <
        div >
        Batal <
        /div> <
