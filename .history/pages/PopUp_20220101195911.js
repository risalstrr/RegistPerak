export default function Home() {
    return ( <
        ...
        <
        button className = "rounded-md border-4 border-[#FAA299] w-28 h-10 transition ease-in-out delay-150 bg-[#EE200C] hover:-translate-y-1 hover:scale-110 hover:bg-[#FAA299] duration-300 ... " >
        Batal <
        /button> <
