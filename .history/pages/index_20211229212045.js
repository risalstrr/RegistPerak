      ...
      <div className=' flex flex-col lg:flex-row bg-[#F1D78E]'>
        ...
        <div className='lg:flex flex-col lg:flex-row justify-end bg-[#F1D78E] w-full py-4 lg:py-0 hidden md:hidden'>
          <div className=' flex flex-col lg:flex-row'>
            <a href="#" className='block px-4 py-3 lg:py-4 text-sm font-bold font-sans '>Score</a>
            <a href="#" className='block px-4 py-3 lg:py-4 text-sm font-bold font-sans'>Games Map</a>
            <a href="#" className='block px-4 py-3 lg:py-4 text-sm font-bold font-sans'>Team Profile</a>
            <a href="#" className='block px-4 py-3 lg:py-4 text-sm font-bold font-sans'>News</a>
            <a href="#" className='block px-4 py-3 lg:py-4 text-sm font-bold font-sans'>Explore Cafeteria</a>
            <a href="#" className='block px-4 py-3 lg:py-4 text-sm font-bold font-sans'>Merchandise</a>
          </div>
        </div>
      </div>  
        <div className="pl-10 pt-10 text-[#6A7CC8] text-[50px] font-['Montserrat'] font-extrabold-[100]">
        <p>Pendaftaran Games Individual</p>
      </div>
      <div className="pl-10 pt-1 text-white text-[28px] font-[900] font-['MADE Sunflower']">
        <h2>Brawlhalla</h2>
      </div>
