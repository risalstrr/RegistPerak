export default function Home() {
    return ( <
        div className = "bg-white w-full h-screen flex flex-col justify-center items-center md:px-1 mb-24 font-['Montserrat'] " >
        <
        div className = "bg-[#E5B632] relative md:w-full md:h-80 lg:w-4/12 lg:h-72 bg-white rounded-lg" >
        <
        div className = "" >
        <
