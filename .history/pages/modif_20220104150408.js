...
export default function Home() {
    return ( <
        div className = "bg-[#EBC761] h-[90rem] w-full" >
        <
        ...
        p > kamu inginkan < /p> <
        /div> <
        div className = "outline-title pl-10 text-white text-[24px] font-['MADE Sunflower'] font-[900]" >
        <
        ...
        <
        div className = 'w-56 h-56 border-[#8648BA] rounded-lg shadow-2xl bg-[#8648BA]' >
        <
        button className = ' w-52 h-52 items-center border-[#8648BA] rounded-lg shadow-2xl bg-[#2E1145]' >
        <
        /button> <
        /div> <
        /div> <
        ...
        <
        /div> <
        div class = "absolute -bottom-[900px] -right-[180px]" >
        <
        Image src = "/merah.svg"
        width = { 400 }
        height = { 360 }
        ...
        <
        /div> <
        div className = 'hidden lg:block lg:absolute -bottom-[380px] -left-6' >
        <
