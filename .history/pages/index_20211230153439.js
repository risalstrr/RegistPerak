  ...
  return (
    <div className="bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <div className='space-y-10 md:grid md:grid-cols-5 pl-10'>
        ...
        <input type="text" name="namaLengkap" class="mt-1 px-3 py-2 bg-white border shadow-sm w-9/12 border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1"/>
      </label>
        {/* <div className=''>
          <Image
            src="/profile.svg"
