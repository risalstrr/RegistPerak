...
export default function Home() {
  ...
  return (
    <div className="bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <div className='block pl-10 pt-3'>
      <button className="rounded-lg w-28 h-10 transition ease-in-out delay-150 bg-[#CC9D1A] border-2 border-[#F1D78E] hover:-translate-y-1 hover:scale-110 hover:bg-[#F1D78E] duration-300 ... ">
          Upload File
      </button>
      </div>
