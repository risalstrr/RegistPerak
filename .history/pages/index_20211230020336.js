  ...
  return (
    <div className="bg-[#EBC761] w-full h-screen">
      ...
      <div className='flex pl-9 items-end'>
        ...
        <input type="email" name="email" class="mt-1 px-3 py-2 bg-white border shadow-sm w-[32] border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1"/>
      </label>
      </div>
