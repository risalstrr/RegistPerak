  ...
  return (
    <div className="bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <Head>
        ...
        <div className="pl-10 pr-10 pt-10 text-[#6A7CC8] text-[50px] font-extrabold">
      ...
      <div className='space-y-10 md:grid md:grid-cols-5 pl-10'>
        ...
        <input type="text" name="pilih gambar" class="mt-1 px-3 py-2 bg-white border-2 shadow-sm w-9/12 border-black placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1"/>
      </label>
      </div>
      
      <div className='block pl-10 pt-3'>
      <button className="rounded-lg w-28 h-10 transition ease-in-out delay-150 bg-[#CC9D1A] border-4 border-[#F1D78E] hover:-translate-y-1 hover:scale-110 hover:bg-[#F1D78E] duration-300 ... ">
          Upload File
      </button>
      </div>
      <label className="block pl-10 pt-10">
        ...
        <input type="text" name="NPM" class="mt-1 px-3 py-2 bg-white border-2 shadow-sm w-4/12 border-black placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="1900000000"/>
      </label>
      <label className="block pl-10 pt-10">
        <span class="after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700 ">
          ID Line/WhatsApp
        </span>
        <input type="text" name="id" class="mt-1 px-3 py-2 bg-white border-2 shadow-sm w-4/12 border-black placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="aangperak21"/>
      </label>

      <div className='block pl-10 pt-10 pb-20'>
      <button className="rounded-lg lg:w-4/12 lg:h-10 border-8 border-[#03F182] md:w-4/12 md:h-12 w-5/12 h-12 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ...">
          Daftar Sekarang
      </button>
      </div>
