...
export default function Home() {
    ...
    return ( <
        ...
        input type = "text"
        name = "pilihGambar"
        className = "mt-1 py-2 bg-white border shadow-sm w-80 border-gray-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" / >
        <
        /label> <
        /div> <
        div className = 'block pl-10 pt-3' >
