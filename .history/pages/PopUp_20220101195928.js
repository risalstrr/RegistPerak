export default function Home() {
    return ( <
        ...
        div >
        <
        div className = "text-[#6A7CC8] font-extrabold md:text-[30px] text-[35px] pl-10 pr-10 pt-3 text-center ..." >
        <
        ...
        <
        button className = "rounded-md border-4 border-[#FAA299] w-56 h-10 transition ease-in-out delay-150 bg-[#EE200C] hover:-translate-y-1 hover:scale-110 hover:bg-[#FAA299] duration-300 ... " >
        Batal <
        /button> <
        button className = "rounded-md border-4 border-[#03F182] w-28 h-10 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ... " >
        Simpan <
        /button> <
        /div> <
        /div> <
