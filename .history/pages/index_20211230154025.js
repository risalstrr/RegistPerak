  ...
  return (
    <div className="bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <div className=' flex flex-col lg:flex-row bg-[#F1D78E]'>
        ...
        <div className="p-10 pt-10 text-[#6A7CC8] text-[50px]  font-extrabold">
        <p>Pendaftaran Games Individual</p>
      </div>
      <div className="p-10 text-white text-[28px] font-['MADE Sunflower'] font-[900]">
        <h2>Brawlhalla</h2>
      </div>
      <div className="p-10 pt-5 text-black text-[15px]  font-extrabold">
        <p>Biaya pendaftaran : Rp xx.xxx</p>
      </div>
      <div className="p-10 text-black text-[10px] ">
        <p>Instruksi pembayaran diberikan setelah mengisi form pendaftaran</p>
      </div>
        
      <div className="flex p-10 pt-5 pb-5 items-center ">
      ...
      <label className="block p-10 pt-3">
        <span class="after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700 ">
          Nama Panggilan
        </span>
      ...
      <div className='space-y-10 md:grid md:grid-cols-5 pl-10'>
        ...
        <input type="text" name="pilihGambar" class="mt-2 px-3 py-2 bg-white border shadow-sm border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1"/>
      </label> */}
      </div>
      ...
      <button className="rounded-lg lg:w-4/12 lg:h-10 w-5/12 h-12 transition ease-in-out delay-150 bg-[#028F4D] hover:-translate-y-1 hover:scale-110 hover:bg-[#03F182] duration-300 ...">
          Daftar Sekarang
      </button>
      </div>
