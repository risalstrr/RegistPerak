  ...
  return (
    <div className="bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <div className=' flex flex-col lg:flex-row bg-[#F1D78E]'>
        ...
        <div className="pl-10 pt-10 text-[#6A7CC8] text-[50px]">
        <p className='font-black'>Pendaftaran Games Individual</p>
      </div>
      ...
      <label className="block pl-10">
        ...
        <input type="text" name="namaLengkap" className=" mt-1 px-3 py-2 bg-white border shadow-sm w-4/12 border-black-400 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="Aang Perak" />
      </label>
      ...
      <label className="block pl-10 pt-3">
        ...
        <input type="text" name="namaPanggilan" className="mt-1 px-3 py-2 bg-white border shadow-sm w-4/12 border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1 border-4 border-indigo-500/100 ..." placeholder="Aang Aja" />
      </label>
      ...
      <div className='flex pl-8 items-end'>
        ...
        <input type="text" name="pilihGambar" className="mt-1 px-3 py-2 bg-white border shadow-sm w-80 border-gray-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1"/>
      </label>
      </div>
      <div className='block pl-10 pt-3'>
      ...
      <label className="block pl-10 pt-10">
        ...
        <input type="text" name="NPM" className="mt-1 px-3 py-2 bg-white border shadow-sm w-4/12 border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="1900000000"/>
      </label>
      <label className="block pl-10 pt-10">
        <span class="after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700 ">
          ID Line/WhatsApp
        </span>
        <input type="text" name="id" className="mt-1 px-3 py-2 bg-white border shadow-sm w-4/12 border-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="aangperak21"/>
      </label>

      <div className='block pl-10 pt-10 pb-20'>
      <button className="bg-[#028F4D] rounded-lg w-4/12 h-10 ">
          Daftar Sekarang
      </button>
      </div>
