...
export default function Home() {
  ...
  return (
    <div className="bg-[#EBC761] w-full h-full font-['Montserrat']">
      ...
      <div className='space-y-10 md:z-10 md:grid md:grid-cols-5 pl-10'>
      ...
      <div className='block pl-10 pt-3'>
      <button className="rounded-lg z-10 w-28 h-10 transition ease-in-out delay-150 bg-[#CC9D1A] border-4 border-[#F1D78E] hover:-translate-y-1 hover:scale-110 hover:bg-[#F1D78E] duration-300 ... ">
          Upload File
      </button>
      </div>
      ...
      <div class="absolute md:z-8 lg:-bottom-4 lg:left-[772px] -bottom-44 -left-60  ">
            <Image
            src="/kuning.svg"
            width={380}
            height={366}
