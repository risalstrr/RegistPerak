export default function Home() {
    return ( <
        ...
        /p> <
        /div> <
        div className = 'flex flex-wrap gap-6 justify-center items-center px-4 py-3 lg:py-0' >
        <
        ...
        <
        button className = "rounded-md border-2 justify-center border-black w-56 h-10 transition ease-in-out delay-150 bg-[#EE200C] hover:-translate-y-1 hover:scale-110 hover:bg-[#FAA299] text-white duration-300 ... " >
        Batal <
        /button> <
        /div> <
