export default function Home() {
    return ( <
        ...
        /p> <
        /div> <
        div className = 'flex flex-wrap gap-6 justify-center px-4 py-3 lg:py-0' >
        <
        div className = "rounded-md border-2 justify-center border-black w-80 h-14 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 bg-[#FAA299]" >
        <
