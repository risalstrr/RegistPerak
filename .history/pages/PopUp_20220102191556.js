export default function Home() {
    return ( <
        ...
        <
        div className = "rounded-md place-items-center border-2 border-black w-54 h-14 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 bg-[#FAA299]" >
        <
